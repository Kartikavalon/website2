...
4. Add two variables:
   ...
   - **Name:** `CONTACT_EMAIL`
     **Value:** `Onboarding@mm.zenoway.co.in` (or your preferred email)
5. Click "Save"
...
4. You should receive an email at `Onboarding@mm.zenoway.co.in`
...
### You receive:
- Full quote request details at `Onboarding@mm.zenoway.co.in`
